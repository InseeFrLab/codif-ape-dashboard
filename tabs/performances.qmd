...
def plot_IC():
    return helpers.plot_IC_distrib(golden_test, "Response.IC", "result", vline=input.threshold(),xaxis_title=None,
                ...
                legend_title=None,
                barmode="overlay",
                color_discrete_sequence=["#003299", "#FFB400"],
                nbins=int(1/0.005))
```
...
```{python}
#| title: "Taux de performance pour les liasse en reprise"
...
```{python}
#| title: "Taux de performance pour les liasse en reprise sur les K premiers echos"
