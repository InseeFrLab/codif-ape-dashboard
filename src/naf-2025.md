...
const surfOptions = options.map(option => option.split(" - ")[0]);
...
const surf = Generators.input(surfOptions);
...
const natOptions = natOptionsDisplay.map(option => option.split(" - ")[0]);
