...
<div class="grid grid-cols-3 grid-rowspan-2">
  ...
  <div class="card grid-colspan-1 grid-rowspan-2">
    <h1 class="results">${predictions_arr[3].code} 🥉</h1>
    <h2>${predictions_arr[3].libelle}</h2>
    <h3>Confiance : ${(predictions_arr[3].probabilite * 100).toFixed(2)}%</h3>
  </div>

  <div class="card grid-colspan-1 grid-rowspan-2">
    <h1 class="results">${predictions_arr[4].code} 🥉</h1>
    <h2>${predictions_arr[4].libelle}</h2>
    <h3>Confiance : ${(predictions_arr[4].probabilite * 100).toFixed(2)}%</h3>
  </div>
</div>
